...
from . models import Product,Contact#> : এই লাইনে বর্তমান ডিরেক্টরি থেকে models.py ফাইলের মধ্যে থাকা Product মডেলকে ইমপোর্ট করা হচ্ছে। Django-তে, মডেল ব্যবহার করা হয় ডাটাবেস টেবিল নির্দেশ করার জন্য।
